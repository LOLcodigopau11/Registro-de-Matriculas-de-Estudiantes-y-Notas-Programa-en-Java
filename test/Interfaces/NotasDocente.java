...
import Controladores.CTRDocente;
import java.awt.Image;
import java.awt.Toolkit;


public class NotasDocente extends javax.swing.JFrame {

    private CTRDocente ctrDocente;
    public NotasDocente() {
        initComponents();
        ...
        //ctrDocente = new CTRDocente(this);
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(92, 146, 164));
        ...
        nombreCurso.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        nombreCurso.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        nombreCurso.setBorder(null);
        ...
        btnRegresar.setBackground(new java.awt.Color(92, 146, 164));
        ...
        tblNotas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Periodo", "Mes Inicio", "Codigo", "Apellidos", "Nombres", "Turno", "Numero Nota", "NOTA"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotasDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotasDocente().setVisible(true);
            }
        });
    }
