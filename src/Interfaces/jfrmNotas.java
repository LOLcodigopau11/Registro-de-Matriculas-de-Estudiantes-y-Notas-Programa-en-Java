...
public class jfrmNotas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEliminar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(92, 146, 164)));
    ...
    private void eliminarNota() {
        // Verificar si se ha seleccionado una fila
        if (tblNotas.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Por favor, seleccione una fila para eliminar la nota.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        // Obtener el número de nota de la fila seleccionada
        int numNota = Integer.parseInt(txtNumNota.getText().trim());
        // Mostrar un JOptionPane de confirmación
        int confirmacion = JOptionPane.showConfirmDialog(this, "¿Estás seguro de que quieres eliminar esta nota?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
    
        // Verificar si el usuario ha confirmado la eliminación
        if (confirmacion == JOptionPane.YES_OPTION) {
            // Crear la consulta SQL para eliminar la nota
            String sql = "DELETE FROM tb_nota WHERE num_nota = ?";
            try (Connection conn = ConexionBD.conectarBD();
                 PreparedStatement pst = conn.prepareStatement(sql)) {
                // Establecer el valor del parámetro en la consulta SQL
                pst.setInt(1, numNota);
                ...
                JOptionPane.showMessageDialog(this, "Error al eliminar la nota: " + ex.getMessage());
                Logger.getLogger(InicioDocente.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
